...
# AdaptiveCpp JIT mode benchmark - using 'generic' target with JIT compilation

echo "=============================================="
echo "SYCL Constant Folding Benchmark Suite"
echo "AdaptiveCpp - JIT Mode (generic)"
echo "=============================================="
echo ""
...
# Force generic target
ACPP_TARGETS="generic"
echo "Using backend: $ACPP_TARGETS (JIT compilation)"
echo ""

BUILD_DIR=build-benchmark-adaptivecpp-jit
mkdir -p $BUILD_DIR
cd $BUILD_DIR

echo ""
echo "=============================================="
echo "Building Benchmark (JIT Mode)"
echo "=============================================="
echo ""
echo "Compilation mode: JIT (generic target)"
echo "  --acpp-targets=generic"
echo "  Device code will be JIT compiled at runtime"
echo ""
...
# Configuration
NUM_TRIALS=5
RESULTS_FILE="benchmark_results_jit_$(date +%Y%m%d_%H%M%S).txt"
...
SYCL Constant Folding Benchmark Results (AdaptiveCpp JIT Mode)
===============================================================
Date: $(date)
Compiler: $ACPP_VERSION
Backend: $ACPP_TARGETS
Mode: JIT (generic target with runtime JIT compilation)
...
Expected: With generic (JIT) target, specialization constants SHOULD work
...
EOF
    ...
    echo "=============================================="
    echo "BENCHMARK FAILED (JIT Mode)"
    echo "=============================================="
    echo ""
...
echo "=============================================="
echo "BENCHMARK PASSED (JIT Mode)"
echo "=============================================="
echo ""
